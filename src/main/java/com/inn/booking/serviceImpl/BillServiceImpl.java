...
import com.inn.booking.service.BillService;
...
public class BillServiceImpl implements BillService {
	...
	public ResponseEntity<String> generateReport(Map<String, Object> requestMap) {
		...
		try {
			...
			if (validateRequestMap(requestMap)) {
				if (requestMap.containsKey("isGenerate") && !(Boolean) requestMap.get("isGenerate")) {// && !(Boolean) requestMap.get("isGenerate")
	...
	private void addTableHeader(PdfPTable table) {
		...
		Stream.of("Name", "Ctagory", "Quantity", "Price", "Sub Total").forEach(columnTitle -> {
	...
	private void setRectanguleInPdf(Document document) throws DocumentException {
		try {
			log.info("Inside setRectanguleInPdf");
	...
	private void insertBill(Map<String, Object> requestMap) {
		try {
			...
			bill.setAppointmentDetail((String) requestMap.get("appointmentDetails"));
	...
	private byte[] getByteArray(String filePath) throws Exception {
		File initialFiale = new File(filePath);
		InputStream targetSteam = new FileInputStream(initialFiale);
